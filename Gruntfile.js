...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            dist: {
                src: [
                    ...
                    path.join(jsPath, "ui/widgets/participant-list.js"),
        ...
        uglify: {
            ...
            dist: {
                files: {
                    '<%= jsPath%><%= pkg.name %>.min.js': ['<%= concat.dist.dest %>']
                }
            }
        },
        lint: {
        ...
        jshint: {
            all: ['Gruntfile.js', 'routes/index.js', jsPath + '*.js', jsPath + 'ui/*.js'],
            options: {
                "boss": true,
                "curly": true,
                "eqeqeq": true,
    ...
    grunt.registerTask('cssmin', function() {
        ...
        + ' -o '
        + path.join(cssPath, "style.min.css");
