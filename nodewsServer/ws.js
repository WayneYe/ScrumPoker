  ...
  return net.createServer(function (socket) {
    ...
    function handshake(data) {
      ...
      if ( _headers[ _headers.length - 1 ] ) {
		...
		//sys.debug("upgradeHead: " + upgradeHead);
      ...
      if ( headers["sec-websocket-key1"] && headers["sec-websocket-key2"] && upgradeHead ) { // 76
        ...
        //sys.debug("packed key1: " + key1);
        //sys.debug("packed key2: " + key2);
        ...
        /*Debug use*/
        //sys.debug("hashed key1: " + key1);
        //sys.debug("hashed key2: " + key2);
        //sys.debug("hashed upgradeHead: " + upgradeHead);
